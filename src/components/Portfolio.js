...
const otherProjects = [
  ...
  {
    title: "Pok̩dex Mobile App",
    description:
      "Mobile app built with Ionic + Angular that consumes the Pok̩mon API.",
    features: [
      "Search Pok̩mon by ID",
